...
const defaultTools = {
    ...
    setMapStandardStyle: {
        ...
        relatedTools: ['getStandardMapStyles', 'setLanguage', 'getMapStyleLayers'],
    },
    setLanguage: {
    ...
    toggleTilesPOIs: {
        ...
        relatedTools: ['discoverPlaces', 'setMapStandardStyle'],
    },
    describeMapStyling: {
    ...
    setMapStyling: {
        ...
        examples: [
            ...
            'setMapStyling({ set: { "colors.water": "#0fa8c8", "colors.roadMajor": "#f59e0b" } })',
        ...
        examplePrompts: [
            ...
            'Hide the road labels',
            'Turn off the building layer',
            'Make the water teal and the motorways orange',
            'Use our brand colours on the map: dark land, light labels',
            'Make the base map quieter so my data stands out',
            'Reset the map styling',
        ],
        relatedTools: ['describeMapStyling', 'setMapStandardStyle', 'toggleTilesPOIs'],
    },
