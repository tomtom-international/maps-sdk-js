...
export const fitRouteSectionDescription =
    'Fit the camera to a specific route section by type + ID (obtain ids from `recallState({ id })` detail mode or via `analyseData` over routes). Requires a route on the map.';
