...
For contributor guidance on tool design, context management, evals, and reliability standards, see [ENGINEERING-GUIDELINES.md](./ENGINEERING-GUIDELINES.md).
...
**Peer:**
- `@tomtom-org/maps-sdk` (workspace) - SDK (types, services, map)
