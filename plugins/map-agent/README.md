...
```typescript
import { type ToolEntry, createMapAgent } from '@tomtom-org/maps-sdk-plugin-ai-agent';
import { z } from 'zod';
...
```typescript
import { createToolState, type ToolState } from '@tomtom-org/maps-sdk-plugin-ai-agent';
...
import { createToolState, DEFAULT_TOOLS, BASE_SYSTEM_PROMPT } from '@tomtom-org/maps-sdk-plugin-ai-agent';
...
```typescript
import { DEFAULT_TOOLS, createMapAgent } from '@tomtom-org/maps-sdk-plugin-ai-agent';
