...
```jsonc
{
  "name": "@tomtom-org/maps-sdk-plugin-ai-agent",
  "version": "0.1.0",
  "type": "module",
  "dependencies": {
...
- Should be a separate package entrypoint (`@tomtom-org/maps-sdk-plugin-ai-agent/react`) to avoid forcing React as a dependency
