 ...
 */
export function createGetShownRouteTrafficIncidentsTool(state: ToolState): Tool {
    return tool({
        ...
        execute: async (): Promise<z.infer<typeof getShownRouteTrafficIncidentsOutputSchema>> => {
            try {
