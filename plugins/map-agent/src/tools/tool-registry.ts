...
import {
    ...
    createGetShownRouteIncidentsTool,
...
export const TOOL_REGISTRY: Record<string, ToolMetadata> = {
    ...
    calculateRoute: {
        ...
        examples: ['calculateRoute("Berlin", "Amsterdam")', 'calculateRoute("NYC", "Boston", ["Hartford"])'],
    ...
    getShownRouteIncidents: {
        name: 'getShownRouteIncidents',
        category: 'map-display',
        shortDescription: 'Get route incidents shown on map',
        description:
            'Get the route incidents currently displayed on the map (not from service, but what is actually shown)',
        tags: ['get', 'shown', 'incidents', 'route', 'displayed', 'map', 'current', 'traffic'],
        parameters: extractParametersFromSchema(getShownRouteIncidentsSchema),
        examples: ['getShownRouteIncidents()'],
        relatedTools: ['showRoute', 'clearMap', 'calculateRoute'],
        create: createGetShownRouteIncidentsTool,
    },
    clearMap: {
        name: 'clearMap',
        category: 'map-display',
