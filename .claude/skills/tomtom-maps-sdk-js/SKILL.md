...
| Map styling (knobs)    | `map-styling.md`     | StylingModule, styling knobs, describe, catalogue, presets, applyPreset, data-viz, night driving, minimal, label size, icon size, road width, exit numbers, route shields, road arrows, 3D buildings, building footprints, POI micro markers, POI min zoom, zoom shift, POI label colour, traffic congestion colours, incident colours, globe, projection, sky, atmosphere, 3D terrain, terrain exaggeration, restyle base map, brand the map, setMapStyling, describeMapStyling, setMapColors, MapColors, MapColorName, mapColorNames, map colours, colors.land, colors.water, colors.roadMajor, land colour, water colour, vegetation, park, artificial, road colour, road outline, label colour, palette, recolour the map, brand colours, exportStyle, export the style, StyleSpecification |
