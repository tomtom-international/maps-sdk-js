...
|------------------------|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Map setup              | `map-setup.md`       | map, display, language, module, maplibre, baseMap, TerrainModule, hillshade, 3D terrain, elevation, elevationExaggeration, terrain exaggeration, TERRAIN_SOURCE_ID, viewport, layer, non-interactive, bounds, style switcher |
...
| Map styling (knobs)    | `map-styling.md`     | StylingModule, styling knobs, describe, catalogue, presets, applyPreset, data-viz, night driving, minimal, label size, icon size, road width, exit numbers, route shields, road arrows, 3D buildings, building footprints, POI micro markers, POI min zoom, zoom shift, POI label colour, traffic congestion colours, incident colours, globe, projection, sky, atmosphere, restyle base map, brand the map, setMapStyling, describeMapStyling, setMapColors, MapColors, MapColorName, mapColorNames, map colours, colors.land, colors.water, colors.roadMajor, land colour, water colour, vegetation, park, artificial, road colour, road outline, label colour, palette, recolour the map, brand colours, exportStyle, export the style, StyleSpecification |
| Module lifecycle events | `module-events.md`  | config-change, shown-features, module events, ModuleEvents, CombinedEvents, applyConfig, updateConfig, resetConfig, setVisible, unsubscribe, named event scopes, events.where                                   |
| Places & search        | `places.md`          | search, places, poi, fuzzy, geocode, address, reverse, autocomplete, geoBias, ev, charging, geometry, polygon, within, along route, route search, detour, viewportplaces, optional summary fields, totalResults, fuzzyLevel, queryIntent, score |
...
| Map effects plugin     | `map-effects.md`     | map-effects, MapEffects, bloom, glow, vignette, tint, fog, edge blur, depth of field, depthOfField, bokeh, defocus, tilt shift, focus band, WebGL pass, bloom.only, onlyTolerance, bloom scope, scope bloom, BloomScope, glow only the traffic, glow the route, light one module, colour key, stylingColorKnobIds, grade, brightness, contrast, saturation, mute the base map, dim the map under data, post-processing, capture, high-DPI, print, preserveDrawingBuffer |
| Landmarks 3D plugin    | `landmarks-3d.md`    | landmarks-3d, Landmarks3D, 3D landmarks, Orbis landmarks, GLB tiles, Three.js, fill-extrusion, display mode, inherited/dark/light, landmarks on terrain, minZoom, maxZoom, ModelsLayer, custom layer, buildLandmarksTileURL |
...
- **Map modules are async**: `await Module.create(map)` for data-owned modules (Places, Routing, Geometries, CustomGeoJSON, TrafficIncidentOverlay, TrafficAreaAnalytics — a new independent instance per call), `await Module.get(map)` for style-owned ones (BaseMap, POIs, TrafficFlow, TrafficIncidents, Terrain — a shared controller)
