...
### Pull requests (PR)
- The Developer creating PR should invite the whole team
- All the comments need to be addressed in one way or the other 
- Not all the developers need to approve PR before it is closed, it depends on complexity and importance of changes
- If the PR contains only a tiny amount of changes one approval is enough for the merge
- If the PR contains only a minor amount of changes one approval and few hours of waiting for other developers to check it out is enough for the merge
