...
---
Documentation is located in the [docs](./docs) folder. It contains static files written by team and [TypeDoc](https://typedoc.org/) files autogenerated from the code comments.
* The static files are located in the [docs](./docs/api-reference) folder.
* The autogenerated files are located in the [api-reference](./docs/api-reference) folder inside docs folder and they are **not included** in git.
---
