...
const data: [string, GeocodingResponseAPI, GeocodingResponse][] = [
    [
        '0: parsing actual API response',
        {
            summary: {
                query: '1507 zaandam',
                queryType: 'NON_NEAR',
        ...
        },
        {
            ...
            bbox: [4.78348, 52.42248, 4.81969, 52.45513],
            features: [
                {
                    type: 'Feature',
                    geometry: {
                        type: 'Point',
                        coordinates: [4.80221, 52.4388],
                    },
                    bbox: [4.78348, 52.42248, 4.81969, 52.45513],
                    id: 'NL/GEO/p0/7133',
                    properties: {
