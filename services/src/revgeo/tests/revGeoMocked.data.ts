...
const revGeoMockedData: RevGeoMockedTestCase[] = [
    ...
    [
        ...
        },
        {
            ...
            bbox: [126.973232, 37.57406, 126.973443, 37.574619],
            properties: {
                type: 'Point Address',
                address: {
                    buildingNumber: '28',
    ...
    [
        ...
        },
        {
            ...
            bbox: [-36.492804, -54.283191, -36.491432, -54.283083],
            properties: {
                type: 'Street',
                address: {
                    routeNumbers: [],
    ...
    [
        ...
        },
        {
            ...
            bbox: [5.149238, 52.352759, 5.149829, 52.352932],
            properties: {
                type: 'Point Address',
                address: {
                    buildingNumber: '22',
    ...
    [
        ...
        },
        {
            ...
            bbox: [-3.383767, 55.873118, -3.075637, 56.02467],
            properties: {
                type: 'Geography',
                address: {
                    routeNumbers: [],
