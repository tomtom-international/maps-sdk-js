...
export type GeometrySearchRequest = CommonServiceParams &
    SearchByGeometryPayload & {
        ...
        /**
         * A list of categories which could be used to restrict the result to the Points Of Interest of specific categories. The list of categories can be discovered using the POI Categories endpoint.
         ...
         * Examples:
         * [7315025, 7315017] (search Points Of Interest of a category, in this example an Italian (italian) or French (french) Restaurant
         */
        categories?: number[];
        /**
