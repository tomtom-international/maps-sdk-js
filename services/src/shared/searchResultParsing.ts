import type { Brand, Moment, OpeningHours, Place, SearchPlaceProps, TimeRange } from '@tomtom-org/maps-sdk-js/core';
import { toPointFeature } from '@tomtom-org/maps-sdk-js/core';
