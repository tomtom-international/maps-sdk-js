...
with the [`validateRequest`](/javascript/maps/documentation/api-reference/modules/services_shared#CommonServiceParams) services parameter.
...
Each SDK service is an implementation of the same [template](/javascript/maps/documentation/api-reference/modules/services_shared#ServiceTemplate),
...
All the existing service implementation parts are discoverable via the [`customizeService`](/javascript/maps/documentation/api-reference/modules/services_customization#customizeService) object.
