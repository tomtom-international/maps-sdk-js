...
The available [`PublishedStyle`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/map#PublishedStyle) are:
...
Additionally, you can change the style of the map at runtime using the [`setStyle`](/maps-sdk-js/javascript/maps/documentation/api-reference/classes/map.GOSDKMap#setStyle) method on the [`GOSDKMap`](/maps-sdk-js/javascript/maps/documentation/api-reference/classes/map.GOSDKMap) class.
...
When initializing a [`GOSDKMap`](/maps-sdk-js/javascript/maps/documentation/api-reference/classes/map.GOSDKMap), you can exclude modules from the
loaded map style with the `exclude` property in [`GOSDKMapParams`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/map#GOSDKMapParams).
...
The POI layer visibility can be controlled during runtime with the [`VectorTilePOIs`](/maps-sdk-js/javascript/maps/documentation/api-reference/classes/map.VectorTilePOIs) module.
...
It's also possible to filter shown POIs by category or classification group using the `filterCategories()` method on [`VectorTilePOIs`](/maps-sdk-js/javascript/maps/documentation/api-reference/classes/map.VectorTilePOIs).
