...
The Map module provides pre-defined styles that can be used in the application.
They are provided in the [`StyleInput`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/map#StyleInput) as [`PublishedStyle`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/map#PublishedStyle)s.
...
-   `standardLight` and `standardDark` - Styles made for browsing the map in light and dark mode respectively. The `standardLight` style is the default style used by the Map module.
...
The Map module allows you to add style layers such as hill shading to the map style.
