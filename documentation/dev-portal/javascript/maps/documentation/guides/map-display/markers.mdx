...
You can customize the Places marker icons in the [`GeoJSONPlaces`](/maps-sdk-js/javascript/maps/documentation/api-reference/classes/map.GeoJSONPlaces) module
