...
# The Traffic module
The [`TrafficModule`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule) is a [map-style based module](/javascript/maps/documentation/guides/map/quickstart#map-style---based-modules)
...
```
* [Initialize a Traffic module](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#get) for your running map (default config):
```javascript
...
### Configuring on init
With the `config` parameter you can set all the configuration you want right when the module is [initialized](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#get).
...
With the `config` parameter in [`applyConfig`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#applyConfig)
...
You can change key configuration parts with dedicated methods which act the same as [`applyConfig`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#applyConfig) just for the part they change.
```javascript
const traffic = await TrafficModule.get(map);
...
All map modules offer a [`resetConfig`](/javascript/maps/documentation/api-reference/classes/map_shared.AbstractMapModule#resetConfig) method which will reset the module config to defaults.
...
* `visible` properties inside `incidents` in the config object upon module [init](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#get)
* `visible` properties inside `incidents` in the config object in [`applyConfig`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#applyConfig).
* [`setIncidentsVisible`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#setIncidentsVisible)
* incident icons visibility via [`setIncidentIconsVisible`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#setIncidentIconsVisible)
...
* [`setFlowVisibility`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#setFlowVisible)
* `visible` property inside `flow` in the config object upon module [init](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#get)
* `visible` property inside `flow` in the config object in [`applyConfig`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#applyConfig).
...
* the `filters` properties inside `incidents` in the config object upon module [init](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#get)
* the `filters` properties inside `incidents` in [`applyConfig`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#applyConfig)
* [`filterIncidents`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#filterIncidents)
...
* the `filters` properties inside `flow` in the config object upon module [init](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#get)
* the `filters` properties inside `flow` in [`applyConfig`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#applyConfig)
* [`filterFlow`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule#filterFlow)
