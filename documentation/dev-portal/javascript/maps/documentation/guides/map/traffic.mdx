...
The [`TrafficIncidentsModule`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficIncidentsModule)
and [`TrafficFlowModule`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficFlowModule)
