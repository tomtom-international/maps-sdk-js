...
```javascript
	const map = new TomTomMap({ container: "map" }, { style: { type: "published", include: ["traffic_flow"]}});
```
...
```
* [Initialize a Traffic module](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficFlowModule#get) for your running map (default config):
```javascript
...
### Configuring on init
With the `config` parameter you can set all the configuration you want right when the module is [initialized](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficFlowModule#get).
...
With the `config` parameter in [`applyConfig`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficFlowModule#applyConfig)
...
* [`setVisible`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficFlowModule#setVisible)
* `visible` property in the config object upon module [init](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficFlowModule#get)
* `visible` property in the config object in [`applyConfig`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficFlowModule#applyConfig).
...
With traffic filtering you can, at any time, change what types of traffic flow ou display in more detail.

You can filter traffic flow via:
* the `filters` properties in the config object upon module [init](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficFlowModule#get)
* the `filters` properties in [`applyConfig`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficFlowModule#applyConfig)
* [`filter`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficFlowModule#filterFlow) method
