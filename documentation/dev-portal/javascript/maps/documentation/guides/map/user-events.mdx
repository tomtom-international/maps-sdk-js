...
This section explains the different [user event types](/javascript/maps/documentation/api-reference/modules/map_shared#EventType) supported by the TomTom SDK (on top of all the ones already supported by MapLibre).
...
You can configure the hovering cursor when initializing a [TomTomMap](/javascript/maps/documentation/api-reference/classes/map_init.TomTomMap)
via its [events configuration object](/javascript/maps/documentation/api-reference/modules/map_init#MapEventsConfig)
(see `cursorOnHover`).
...
Each map module has an `events` object which returns an [`EventsModule`](/javascript/maps/documentation/api-reference/classes/map_shared.EventsModule) instance
...
[`on`](/javascript/maps/documentation/api-reference/classes/map_shared.EventsModule#on)
and [`off`](/javascript/maps/documentation/api-reference/classes/map_shared.EventsModule#off) methods.

The user events handler is a function of type [`UserEventHandler`](/javascript/maps/documentation/api-reference/modules/map_shared#UserEventHandler).

For example, a hover event handler on traffic incidents ([`TrafficModule`](/javascript/maps/documentation/api-reference/classes/map_traffic.TrafficModule))
...
[`off`](/javascript/maps/documentation/api-reference/classes/map_shared.EventsModule#off) method
on the corresponding [`EventsModule`](/javascript/maps/documentation/api-reference/classes/map_shared.EventsModule).
...
You can configure the size of the padding box when initializing a [TomTomMap](/javascript/maps/documentation/api-reference/classes/map_init.TomTomMap)
via its [events configuration object](/javascript/maps/documentation/api-reference/modules/map_init#MapEventsConfig).
<br/>
