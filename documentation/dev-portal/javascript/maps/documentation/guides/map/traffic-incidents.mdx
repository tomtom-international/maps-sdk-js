...
All map modules offer a [`resetConfig`](/javascript/maps/documentation/api-reference/map_shared.AbstractMapModule#resetConfig) method which will reset the module config to defaults.
...
* [`setVisible`](/javascript/maps/documentation/api-reference/map-traffic.TrafficIncidentsModule#setVisible)
...
* incident icons visibility via [`setIconsVisible`](/javascript/maps/documentation/api-reference/map-traffic.TrafficModule#setIconsVisible)
