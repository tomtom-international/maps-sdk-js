...
The Map Display module comes with multiple pre-defined styles, but it also supports loading custom styles.
...
the [`TomTomMapParams`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/map_init#TomTomMapParams) when initializing
an instance of [`TomTomMap`](/maps-sdk-js/javascript/maps/documentation/api-reference/classes/map_init.TomTomMap).
...
Additionally, you can change the style of the map at runtime using the [`setStyle`](/maps-sdk-js/javascript/maps/documentation/api-reference/classes/map_init.TomTomMap#setStyle) method on the TomTomMap class.
...
When setting the map style, you can exclude modules from the loaded map style with the `exclude` property in [`TomTomMapParams`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/map_init#TomTomMapParams).
...
map style with the `exclude` property of the [`TomTomMapParams`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/map_init#TomTomMapParams).
...
Hill shading is enabled by default. It can be excluded from the map style with the `exclude` property of the [`TomTomMapParams`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/map_init#TomTomMapParams).
