...
The Map Display module allows you to handle route planning and driving actions on the map. This guide covers how to draw [`Routes`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/core#Routes)
and [`Waypoints`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/core#Waypoints) on the map.
...
and an instance of [`TomTomMap`](/maps-sdk-js/javascript/maps/documentation/api-reference/classes/map_init.TomTomMap) is initialized,
then the [`RoutingModule`](/maps-sdk-js/javascript/maps/documentation/api-reference/classes/map_routes.RoutingModule) class can be used to show routes and waypoints.
