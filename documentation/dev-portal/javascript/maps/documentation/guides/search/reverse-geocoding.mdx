...
-   `geography`: Returns the smallest available geographic data.
  ...
  -   You can specify the level of geography to get a geometry (see the [`PlaceType`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/core#placetype) parameter).
...
Specify the reverse geocoding request parameters with the [`ReverseGeocodingParams`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/services#reversegeocodingparams).

``` javascript
const reverseGeocodeParams = { position: [37.786505, -122.3862] };
```

Once you have a [`ReverseGeocodingParams`](/maps-sdk-js/javascript/maps/documentation/api-reference/modules/services#reversegeocodingparams).
...
-   [Autocomplete and fuzzy search (TODO)](/maps-sdk-js/javascript/maps/documentation/guides/search/autocomplete-and-fuzzy-search)
-   [Specialized search types (TODO)](/maps-sdk-js/javascript/maps/documentation/guides/search/specialized-search)
-   [Adding markers to the map (TODO)](/maps-sdk-js/javascript/maps/documentation/guides/map-display/markers)
