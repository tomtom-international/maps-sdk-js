...
A [`WaypointLike`](/web/maps/documentation/api-reference/modules/core/#waypointlike) is either a complex [`GeoInputs`](/web/maps/documentation/api-reference/modules/core/#waypoint) object or anything with coordinates.
...
By default, a [`GeoInputs`](/web/maps/documentation/api-reference/modules/core/#waypoint) is considered a single point, unless a [`radius`](/web/maps/documentation/api-reference/modules/core/#waypoint) is specified, which then transforms the waypoint into a circle (soft) waypoint.
