...
const applyChartTheme = (): void => {
    ...
    const text = readToken('--ui-text-med-em', '#5b6470');
    const textStrong = readToken('--ui-text-high-em', '#1a1d21');
    const line = readToken('--ui-border-low-em', 'rgba(0,0,0,0.08)');
    const surface = readToken('--ui-surface-0', '#ffffff');
