# TomTom Maps SDK Agent Toolkit — Traffic Manager Example

This example demonstrates the TomTom Maps SDK Agent Toolkit plugin set up as a traffic-manager assistant: it monitors live incidents, clusters hotspots, computes per-area analytics, and lets the agent drive focus changes on the map.
...
The TomTom Maps SDK Agent Toolkit plugin combines:
