...
/** Interpolates 0-100 through green → amber → red. */
...
/**
 * Adds `days` days to a date string, returning a new YYYY-MM-DD string.
 */
...
/**
 * Formats a YYYY-MM-DD string into "Wed Mar 12" style label.
 */
...
/**
 * Renders a day × hour congestion grid on a `<canvas>`.
 *
