...
describe('locations util tests', () => {
    ...
    test('To display waypoints', () => {
        ...
        const result1 = toDisplayWaypoints(
            ...
            features: [
                {
                    ...
                    // id will be auto-generated by GeoJsonSource 'promoteId' behavior
                    geometry: { type: 'Point', coordinates: [1, 2] },
        ...
        expect(result1.features[0].id).toBe(result1.features[0].properties.id);
        const result2 = toDisplayWaypoints(
            [buildTestWaypoint({ entryPoints: [{ type: 'main', position: [44, 55] }] }, [1, 2])],
            {
        ...
        expect(result2.features[0].id).toBe(result2.features[0].properties.id);
