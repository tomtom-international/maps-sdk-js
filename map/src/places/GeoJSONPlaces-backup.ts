...
//     private static instancesCount = -1;
...
//         const layerSpec = buildPlacesLayerSpec(config, GeoJSONPlaces.instancesCount, this.mapLibreMap);
//         this.places = new GeoJSONSourceWithLayers(
//             this.mapLibreMap,
//             `${PLACES_SOURCE_ID}-${GeoJSONPlaces.instancesCount}`,
...
//         const newLayerSpec = buildPlacesLayerSpec(config, GeoJSONPlaces.instancesCount, this.mapLibreMap);
